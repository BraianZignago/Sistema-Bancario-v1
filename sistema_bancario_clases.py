...
class PessoaFisica(Cliente):
    def __init__(self, nome, data_nacimento, cpf, endereco):
...
class Conta():
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            print("!!!!ERROR!!!! Algo falhou! Seu saldo não é suficiente")
            ...
            print("!!!!ERROR!!!! Algo falhou! Formato invalido")
...
class Saque(Transacao):
    ...
    def registrar(self, conta):
        ...
        if sucesso_transacao:
            conta._historico.add_transacao(self)
...
def criar_cliente(clientes):
    ...
    cliente = PessoaFisica(nome=nome, data_nacimento=data_nascimento, cpf=cpf, endereco=endereco)
...
main()
print("Muito obrigado por usar nossa rede de Banco SISCRED")
